...
- `tests/test_doctor_extraction_matrix.py`: locks the 4 (markitdown × legacy CLI) combinations of `doctor.check_extraction` + the optional/silent behavior of `chinese_ocr`. Future refactor must keep the matrix.
